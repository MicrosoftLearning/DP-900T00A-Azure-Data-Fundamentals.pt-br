...
1. No gerenciador de armazenamento, verifique se a exibição atual mostra o conteúdo da pasta **produtos** que você acabou de criar. Observe que as "trilhas de navegação" na parte superior da página refletem o caminho **Contêineres de blobs > dados > produtos**.
